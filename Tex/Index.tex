...
\makeatother
    ...
    \section{Multiscale Geographically Weighted Regression - Poisson
dependent
variable}\label{multiscale-geographically-weighted-regression---poisson-dependent-variable}
...
\textbf{\href{https://mehak-sachdeva.github.io/MGWR_book/Html/Poisson_MGWR_univariate_check.html}{Initial
module changes and univariate model check}} - Section \ref{set-up-cells}
- Section \ref{fundamental-equations-for-poisson-mgwr} -
Section \ref{example-dataset} - Section \ref{helper-functions} -
Section \ref{univariate-example} - Section \ref{parameter-check} -
Section \ref{bandwidths-check}

\textbf{\href{Simulated_data_example_Poisson-MGWR.ipynb}{Simulated Data
example}} - Section \ref{set-up-cells} -
...
Section \ref{parameters-check} - Section \ref{multivariate-example} -
Section \ref{bandwidths-random-initialization-check} -
Section \ref{parameters-check} -
Section \ref{global-model-parameter-check}

\textbf{\href{Real_data_example_Poisson-MGWR.ipynb}{Real Data example}}
...
\textbf{\href{Poisson_MGWR_MonteCarlo_Results.ipynb}{Monte Carlo
...
project}\label{introduction-to-the-project}
...
dimensional co-ordinates describing the location i. The Poisson model
for geographically varying parameters can be written as:
